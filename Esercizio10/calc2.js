...
function  calc_keyNumPressed(numPressed){
    ...
    console.log("calc_KeyNumPress: " + numPressed + "displayValue" + displayValue + "currentOperator" + currentOperator + "currentOperand" + currentOperand)
}
...
function isDotPresent(){
    let result = false
    let display= document.getElementById("display")
    if (display.innerText.indexOf(".") >0 -1 ){
        result = true
    }
    return result
}
